...
class BankimTimeline extends StatefulWidget {
  @override
  _BankimTimelineState createState() => _BankimTimelineState();
}

class _BankimTimelineState extends State<BankimTimeline> {
